...
export const imgList = [
    { img: img1, title: "фото 1" },
    { img: img2, title: "фото 2" },
    { img: img3, title: "фото 3" },
    { img: img4, title: "King of the Hill" },
];

export const audioList = [
    { audio: audio1, title: "Аудиофайл 1" },
    { audio: audio2, title: "Аудиофайл 2" },
    { audio: audio3, title: "Аудиофайл 3" },
];
